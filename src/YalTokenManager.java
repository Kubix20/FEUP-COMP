/* YalTokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. YalTokenManager.java */
import java.io.FileReader;
import java.io.FileNotFoundException;

/** Token Manager. */
@SuppressWarnings("unused")public class YalTokenManager implements YalConstants {
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public YalTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public YalTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
